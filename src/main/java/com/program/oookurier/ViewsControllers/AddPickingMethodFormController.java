...
public class AddPickingMethodFormController {
    ...
    void create(ActionEvent event) {
        ...
        ResultSet resultSet = dataBaseClass.query("SELECT * FROM " + DataBaseTables.DB_DELIVERY_METHODS + " WHERE lower(name) = '" + nameField.textProperty().getValue().toLowerCase() + "'");
        ...
        boolean result = dataBaseClass.executeQuery("INSERT INTO " + DataBaseTables.DB_DELIVERY_METHODS + " (\"name\") VALUES ('" + nameField.textProperty().getValue() + "')");
