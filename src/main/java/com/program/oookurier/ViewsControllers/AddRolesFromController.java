...
public class AddRolesFromController {
    ...
    void create(ActionEvent event) {
        ...
        ResultSet resultSet = dataBaseClass.query("SELECT * FROM " + DataBaseTables.DB_ROLES + " WHERE lower(name) = '" + nameField.textProperty().getValue().toLowerCase() + "'");
        ...
        boolean result = dataBaseClass.executeQuery("INSERT INTO " + DataBaseTables.DB_ROLES + " (\"name\") VALUES ('" + nameField.textProperty().getValue() + "')");
