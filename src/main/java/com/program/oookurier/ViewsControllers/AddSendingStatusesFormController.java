...
public class AddSendingStatusesFormController {
    ...
    void create(ActionEvent event) {
        ...
        ResultSet resultSet = dataBaseClass.query("SELECT * FROM " + DataBaseTables.DB_SENDING_STATUSES + " WHERE lower(name) = '" + nameField.textProperty().getValue().toLowerCase() + "'");
        ...
        boolean result = dataBaseClass.executeQuery("INSERT INTO " + DataBaseTables.DB_SENDING_STATUSES + " (\"name\") VALUES ('" + nameField.textProperty().getValue() + "')");
